...
/**
 * q_shuffle - Randomly shuffles elements in a doubly-linked list
 * @head: pointer to the head of the list
 *
 * This function implements the Fisher-Yates shuffle algorithm to
 * randomly reorder elements in a circular doubly-linked list.
 *
 * - The function does not allocate or deallocate memory.
 */
